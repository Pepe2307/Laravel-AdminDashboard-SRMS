        ...
        <div class="card-body">
            ...
            <form action="{{route('update.subject')}}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" required type="text" name="subject_name" value="{{$subject->subject_name}}">
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" required type="text" name="subject_code" value="{{$subject->subject_code}}">
                    </div>
                </div>
                <!-- end row -->
